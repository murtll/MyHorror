...
class FireSkull(private val gameScreen: GameScreen) : GameCharacter(gameScreen) {
    private val textureIdle = TextureRegion(Texture("all/skull/fire-skull-no-fire.png")).split(54, 70).first()
    private val textureAttack = TextureRegion(Texture("all/skull/fire-skull.png")).split(96, 112).first()

    override var race = Race.FIRE_SKULL
    override var texture = textureIdle.first()
    override var chance = 3
    override var speed = 60f
    override var maxHP = 30f
